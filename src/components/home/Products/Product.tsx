...
const Product = (props) => {
 ...
 // const [wishList, setWishList] = useState([]);
  ...
  return (
    <div className="jshop-product-card w-full relative group">
      <div className="jshop-product-media max-w-80 max-h-80 relative overflow-y-hidden">
        ...
        <div className="jshop-product-actions w-full h-32 absolute -bottom-[130px] group-hover:bottom-0 duration-700">
      ...
      <div className="jshop-product-meta max-w-80 py-6 flex flex-col gap-1 px-4">
