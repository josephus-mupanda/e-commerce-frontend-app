    ...
    useEffect(() => {
        const fetchOrder = async () => {
          try {
            ...
            if (order) {
              const orderDetailsResponse = await apiClient.get(`${BASE_URL}/api/customer/orders/${id}`);
            ...
            //   const orderDetailsResponse = await apiClient.get(`${BASE_URL}/api/customer/orders/${orderId}`);
            //   const orderDetails = orderDetailsResponse.data;
            //   console.log("Order details:", orderDetails);
            //   if(id == orderId){
            //     setOrder(orderDetails);
          ...
          const fetchOrderItems = async (orderItemId) => {
            try {
              const response = await apiClient.get(`${BASE_URL}/api/customer/order-items/order/${orderItemId}`);
