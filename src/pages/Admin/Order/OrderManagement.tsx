...
const OrderManagement = () => {
  ...
  useEffect(() => {
    ...
    const fetchOrders = async () => {
      try {
        const response = await apiClient.get(`${BASE_URL}/api/admin/orders`);
  ...
  const handleDelete = async (id) => {
    try {
      await apiClient.delete(`${BASE_URL}/api/admin/orders/${id}`);
  ...
  const handleDispatch = async (id) => {
    try {
      ...
      const response = await apiClient.put(`${BASE_URL}/api/admin/orders/${id}`, 
        { 
